--DISPONIBILIDADE MENSAL PROGRESSIVA - UF
...
LAG(ROUND((1-(TEMPO_ACUM / NULLIF((CAST(PLANTA_ACUM AS FLOAT) * DENOMINADOR),0))) * 100, 2)) OVER (PARTITION BY UF ORDER BY MES, DIA) AS DISP_ANTERIOR
FROM (
    SELECT
    *,
    ...
    FROM (
        ...
        *,
        ...
        FROM (
            ...
            GROUP BY ANO, MES, DIA, UF, REGIONAL
        )A
    )B
)C --ORDER BY UF, DIA
